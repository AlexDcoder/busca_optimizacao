...
def perturb(x, lower_bound, upper_bound, e=2.9):
...
# Defindo espaço de estados
x1_axis = np.linspace(-100, 100)
x2_axis = np.linspace(-100, 100)
...
algo = Algo(x1_axis, x2_axis, 10000, 100, 55)
hc_results = []
lrs_results = []
grs_results = []
